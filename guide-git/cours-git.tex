...
\definecolor{MyLightBlue}{rgb}{0.705,0.956,0.99}
\definecolor{MyBlue}{rgb}{0.705,0.8,0.95}
\definecolor{Bblue}{rgb}{0.0,0.0,0.6}
\definecolor{BDef}{rgb}{0.26,0.06,0.86}
\definecolor{BApi}{rgb}{0.4,0.0,1.0}
\definecolor{BAppli}{rgb}{0.0,0.2,0.4}
\definecolor{Bred}{rgb}{0.5,0.0,0.0}
\newcommand{\ip}[1]{\cbold{Bblue}{#1}}
\newcommand{\vip}[1]{\cbold{Bred}{#1}}
...
%   \begin{footnotesize}\tableofcontents[hideallsubsections]\end{footnotesize}
% \end{frame}
